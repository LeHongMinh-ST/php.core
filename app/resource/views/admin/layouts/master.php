...
<!--end::Global Javascript Bundle-->
<!--begin::Page Custom Javascript(used by this page)-->
<script src="<?php echo asset('/public/admin/assets/js/custom/widgets.js')?>"></script>
<script src="<?php echo asset('/public/admin/assets/js/custom/apps/chat/chat.js')?>"></script>
<script src="<?php echo asset('/public/admin/assets/js/custom/modals/create-app.js')?>"></script>
<script src="<?php echo asset('/public/admin/assets/js/custom/modals/upgrade-plan.js')?>"></script>
